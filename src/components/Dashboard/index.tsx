...
import CreateNewStream from "components/createNewStream";
      ...
      <div className="dashboard-main-content">
        <div className="content-left">
          ...
          <div className="tokenpool-proposal">
            <div className="tokenpool-streams" onClick={onClickTokenPoolStream}>
              Token Pools <br />& Streams
            </div>
            <div className="new-proposal">New Proposal</div>
          </div>
          <div className="voting-social">
            <div className="dao-voting">Voting</div>
            <div className="dao-social">DAO Social</div>
          </div>
        </div>
